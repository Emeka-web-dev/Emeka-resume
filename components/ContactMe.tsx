...
const publicKey: any = process.env.NEXT_PUBLIC_PUBLIC_KEY;
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden text-left max-w-6xl px-10 mx-auto items-center">
      <h3 className=" uppercase tracking-[10px] text-gray-500 text-xl pt-12 md:pt-16">
        Contact
      </h3>
      <div className="flex flex-col space-y-2">
        ...
        <div>
          <Link
            ...
            className="flex items-center space-x-3 py-1 justify-center"
          >
        ...
        <form
          ...
          className="flex flex-col space-y-2 md:mx-auto py-2 md:py-5 flex-shrink-0"
        >
